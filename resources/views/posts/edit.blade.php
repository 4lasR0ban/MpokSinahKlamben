        ...
        <div class="col-lg-10 mx-auto">
            <div class="form-floating mb-3">
                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                    name='title' placeholder="Masukkan judul" value="{{ old('title', $post->title) }}" required autofocus>
            ...
            <div class="form-floating mb-3">
                <input type="text" name="author" class="form-control @error('author') is-invalid @enderror" id="author"
                    placeholder="Masukkan author" value="{{ old('author', $post->author) }}">
            ...
            <div class="mb-3">
                ...
                @if ($post->image)
                    <img class="img-preview img-fluid mb-3 col-sm-5 d-block" src="/storage/{{ $post->image }}">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('body') is-invalid @enderror" name="body" id="summernote" style="height: 100px">{{ old('body', $post->body) }}</textarea>
                @error('body')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
