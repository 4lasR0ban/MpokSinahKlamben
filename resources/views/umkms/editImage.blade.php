...
@section('container')
    ...
    <form action="/admin/umkmImages" method="post" enctype="multipart/form-data">
        @csrf
            ...
            <section class="section">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="javascript:void(0)" class="btn btn-success icon icon-left" title="Add"
                        id="addBtn"><i data-feather="file-plus"></i> <span>Add Image</span></a>
                    </div>
                    <div class="card-body">
