...
<head>
    <meta charset="utf-8">
    <title>Mpok Sinah Klamben</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow border-top border-5 border-primary sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class="d-flex">
                <a class="btn btn-red btn-social d-flex align-items-center" href=""><i class="fab fa-twitter"></i></a>
                <a class="btn btn-red btn-social d-flex align-items-center" href=""><i class="fab fa-facebook-f"></i></a>
                <a class="btn btn-red btn-social d-flex align-items-center" href=""><i class="fab fa-youtube"></i></a>
                <a class="btn btn-red btn-social d-flex align-items-center" href=""><i class="fab fa-instagram"></i></a>
            </div>
            </h4> -->
        </div>
    </nav>
        ...
        <div class="container py-5">
            <div class="row g-5 d-flex justify-content-between">
                <div class="col-lg-3 col-md-6">
                    <img src="{{ asset('img/logo.png') }}" alt="logo" style="max-width: 225px;">
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">Paguyuban Mpok Sinah Klamben</a>, All Right Reserved.
                    </div>
